...
3. If Instagram is visible, use get_screen_info and screenshot only to understand visible context. Do not scrape profiles, hidden data, followers, or private content.
4. Draft three caption options: short, medium, and sales-focused. Include one clear CTA and 3-8 relevant hashtags.
5. If the user asks to prepare the post in Instagram, open Instagram, navigate only as far as the caption field, and type the selected caption.
...
- If the caption field cannot be found: copy-ready text is enough; tell the user to paste it manually.
