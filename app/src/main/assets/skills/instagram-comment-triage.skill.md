...
tools: open_app, get_screen_info, screenshot, scroll, finish
...
3. Open Instagram only if requested. Use get_screen_info and screenshot to read visible comments. Scroll at most 3 times unless the user explicitly asks to continue.
...
- If comments are not visible: ask the user to open the comment screen.
