...
3. If content is visible on screen, use get_screen_info and screenshot to understand it. Read only visible context.
...
5. Keep claims factual. Do not invent prices, availability, guarantees, addresses, discounts, or legal claims.
6. Do not open apps, post, comment, message, like, follow, scrape, or boost. This skill only drafts copy.
...
- If the request is for mass posting or fake engagement: refuse and offer manual platform-safe drafts.
